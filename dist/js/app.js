...
__webpack_require__("./src/js/parallax.js");

__webpack_require__("./src/js/scrollpos.js");

__webpack_require__("./src/js/scrollprogress.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var latestCarousel = function latestCarousel() {
    var glide = new glide_esm(latest, {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var init = function init() {
    var filtersTrigger = document.getElementsByClassName('js-filtersTrigger')[0]; //const label_show = filtersTrigger.getAttribute('data-show');
    ...
    filtersTrigger.addEventListener('click', showHideFilters); //e.preventDefault() ? e.preventDefault() : e.preventDefault = false;
  };
...
var _doc = (gsap_TweenLite["e" /* _gsScope */].document || {}).documentElement,
		_window = gsap_TweenLite["e" /* _gsScope */],
		...
		ScrollToPlugin = gsap_TweenLite["e" /* _gsScope */]._gsDefine.plugin({
			propName: "scrollTo",
			API: 2,
			global: true,
			version:"1.9.2",
...
(function (window, document, cutme, undefined) {
  ...
  var scrollTo = function scrollTo(target, speed, offset) {
    gsap_TweenLite["f" /* default */].to(window, speed, {
      scrollTo: {
        y: target - offset,
        autoKill: false
      },
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.animsInit = function () {
    var _loop = function _loop(i) {
      ...
      var inview = inview__WEBPACK_IMPORTED_MODULE_0___default()(anims[i], function (isInView, data) {
        if (isInView) {
...
var ScrollMagic = __webpack_require__("./node_modules/scrollmagic/scrollmagic/uncompressed/ScrollMagic.js");
var ScrollMagic_default = /*#__PURE__*/__webpack_require__.n(ScrollMagic);

// EXTERNAL MODULE: ./node_modules/gsap/TweenLite.js
var TweenLite = __webpack_require__("./node_modules/gsap/TweenLite.js");
...
Object(scrollmagic_plugin_gsap["ScrollMagicPluginGsap"])(ScrollMagic_default.a, TweenMax_TweenMax, TimelineMax);
document.addEventListener('DOMContentLoaded', function () {
  window.parallax = function () {
    var el = document.getElementsByClassName('js-homeslider')[0];
    var controller = new ScrollMagic_default.a.Controller();
    var tween = TweenMax_TweenMax.to('.js-secondary', 1, {
      height: '100%',
      ease: 'linear'
    });
...
document.addEventListener('DOMContentLoaded', function () {
  (function () {
    var scroll_pos = window.pageYOffset || window.scrollY,
        out = false;
    var el = document.getElementsByClassName('js-top')[0];
    var down,
        lastScrollTop = 0,
        narrow = false,
        ww = window.innerWidth;
